...
if __name__ == '__main__':
    ...
    CGT = ChatGLMTokenizer(vocab_file, padding_side="right")
    vocab_list = CGT.get_vocab()
    save_json(vocab_list, "vocab.json")
    text = "1"
    text_out = CGT.tokenize(text)
    print(text_out)
    text = """<|system|>
...
Hello, I'm ChatGLM3. What can I assist you today?"""
    text_out = CGT.tokenize(text)
    print(text_out)
    text_out = CGT.encode(text, is_split_into_words=True)
    print(text_out)
    text_out = CGT.encode_plus([text], is_split_into_words=True)
    print(text_out)

    query = "I like peace."
    history = [{"role": "user", "content": "what do you like?"}]

    text_out = CGT.build_chat_input(query, history, role="user")
    print(text_out)
...
<|assistant|>
"""
    text_out = CGT.encode_plus([prompt_system], is_split_into_words=True)
    print(text_out)
    print(len(text_out.get('input_ids')))
    text_out = CGT.encode_plus([prompt_input], is_split_into_words=True)
    print(text_out)
    print(len(text_out.get('input_ids')))

    text_out = CGT.encode(prompt_input, is_split_into_words=False)
    print(text_out)
    print(len(text_out))