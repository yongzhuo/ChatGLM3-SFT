...
class CustomTrainer(transformers.Trainer):
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        if local_rank_is_0:  # tensorboard只写rank-0
            logs = {}
...
trainer = CustomTrainer(
        ...
        args=transformers.TrainingArguments(
            ...
            optim="adamw_torch",  # "adafactor",  # "adamw_torch", # "adafactor",  # "adamw_torch",  # "adamw_hf",
...
nohup deepspeed --num_gpus=2 train_deepspeed.py --deepspeed ds.json  > tc.train_deepspeed.py.log 2>&1 &
